---
title: "Homework 7 - scroll to bottom for ARIMA"
...
Solar_Energy_Consumption <- read.csv("C:\\Users\\justi\\OneDrive\\Documents\\Solar Energy Consumption.csv")
...
accuracy(mean_solar) # Using MAPE (mean average percent error) as the accuracy measure, we see that the forecast using the mean is off by about 148.37%. This is a very strong indication not to use this forecast. 
...
# This histogram plot shows that the residuals have a practically normal distribution. The bin with the most residuals is 0 to 0.005, with almost 80 observations. 
...
```{r}
plot(mean_solar, xlab="Time", ylab="Consumption in Quadrillion BTUs", main="Combined Forecasts")
...
seasonal_arima_forecast_solar <- forecast(fit_solar, h=60)
...
plot(seasonal_arima_forecast_solar)
